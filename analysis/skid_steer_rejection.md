...
| File | Description |
|------|-------------|
| `sim/isaac/deprecated/skid_steer_design/step_sweep.py` | Isaac Sim parametric sweep script |
| `sim/isaac/deprecated/skid_steer_design/build_robot.py` | Parametric robot builder |
| `sim/isaac/deprecated/skid_steer_design/ANALYSIS.md` | Detailed results table |
