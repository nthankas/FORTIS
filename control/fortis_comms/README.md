...
These are not blockers for the reorg, but every one of them is something a future ROS wrapping pass will trip over. Listed here so the next / next session doesn't have to rediscover them.
