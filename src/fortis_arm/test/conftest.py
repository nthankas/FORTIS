...
ROS_DOMAIN_ID those processes share one DDS domain: this package's
test-side /fortis/mission_state publisher then cross-talks with the
drive integration test's real mission_state_node, producing intermittent
